...
### Sequences MFE [Minimum Free Energy]
...
### Score ~ self-complementary [%]


```{r out.width="60%", fig.align='center', include=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
knitr::include_graphics("../fig/KIT_score~complementary.svg")
knitr::include_graphics("../fig/PAX3_score~complementary.svg")
